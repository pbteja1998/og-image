...
<html lang="en">
  ...
  <body>
  <div
  class="bg-indigo-900 p-10 w-screen h-screen flex justify-center items-center"
>
  <div
    class="flex flex-wrap justify-between items-center leading-6 text-white md:flex-no-wrap"
  >
    ...
    <div class="text-white">
      <div class="grid grid-cols-3 p-1 mb-1 md:grid-cols-6">
        ...
        <div class="px-2 pt-6 pb-2 text-center md:pt-2">
          <div class="mb-1 text-base font-medium text-gray-100">Supply</div>
          <div
            class="text-2xl font-medium leading-8 uppercase"
            title="$38799.26"
          >
